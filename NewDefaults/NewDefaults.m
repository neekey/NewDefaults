...
- (NSString *) readDefaults: (NSString *)a_domain
    ...
    NSArray *l_arguments = [NSArray arrayWithObjects:
        D_READ_COMMAND, a_domain, a_key, nil ];
...
- (void) didSelect {
    ...
    NSString *l_showHiddenFile =
        [self readDefaults: D_DOMAIN_FINDER
...
- (IBAction)myButtonAction:(id)sender {
    ...
    if (YES == [sender isEqual: enableHomeLibraryCheckbox]) {
        ...
        if (NSOnState == [sender state]) {
            ...
            [l_url setResourceValue: [NSNumber numberWithBool: NO]
        ...
        // else the checkbox is OFF (unchecked)
            ...
            [l_url setResourceValue: [NSNumber numberWithBool: YES]
                             forKey: NSURLIsHiddenKey
                              error: Nil];
        }
    }
